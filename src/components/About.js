    ...
    return (
        <div className="bg-white">
            <div className="container mx-auto content-center pl-12 pr-12 h-screen w-screen float-left xl:flex" id="about">
                <p class="text-left pt-32 pb-12 sm:text-2xl md:text-base lg:text-lg xl:text-2xl 2xl:text-xl 3xl:text-3xl 4xl:text-4xl">
                ...
                <img class="float-right align-top object-scale-down pb-40 justify-center lg:pl-12 lg:pr-12 xs:object-contain md:object-contain lg:object-scale-down" src="https://visitindiana.com/adportal/Content/FileUploads/55098/Muncie.jpg" alt="muncie"></img>
            </div>
        </div>
    );
};
